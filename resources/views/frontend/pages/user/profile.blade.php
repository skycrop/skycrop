    ...
    <div class="flex-1 p-8">
      ...
      <div class="grid md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <form class="space-y-5" method="POST" action="{{route('user.profile.update')}}" enctype="multipart/form-data">
            ...
            <div>
              ...
              <input name="name" type="text" value="{{ $farmerDetail->name }}" required
        ...
        <div>
          ...
          <form id="update-password-form" class="space-y-5" method="POST" action="{{route('user.profile.updatePassword')}}">
            @csrf
            <div>
