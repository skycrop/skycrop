    ...
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        ...
        <div class="space-y-6">
            <div class="rounded-md border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div x-data="farmAdminWizard({{ $farmerId }})" x-init="initValidation()">
                <div class="max-w-5xl mx-auto">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex justify-between text-xs text-primary mt-2">
                    ...
                    <form id="farmFormAdminValidate" @submit.prevent>
                        @csrf
                        <!-- Step 1: Farm Details -->
                        <div x-show="step === 1" x-transition class="space-y-8">                            

                            <h2 class="text-2xl font-bold">Add New Farm</h2>
                            <div class="grid md:grid-cols-2 gap-8">
                                <div>
                                <label class="block text-gray-700 font-semibold mb-2">Farm Name <span class="text-red-500">*</span></label>
                                <input type="text" x-model="farmName" name="farm_name" placeholder="e.g. blue Valley Farm" autofocus
                                        class="form-control" />
                                </div>
                                <div>
                            ...
                            <div class="flex justify-end">
                                <button type="button" @click="validateStep(1)" class="btn-primary px-6 py-2 rounded transition">Next Step &#8594;</button>
                            </div>
                        </div>
                        ...
                        <div x-show="step === 2" x-transition class="space-y-8">
                            <div class="flex items-center justify-between">
                                <h2 class="text-2xl font-bold">Farm Fields</h2>
                            ...
                            <div class="flex gap-3 overflow-x-auto pb-4">
                                ...
                                <button type="button" @click="activeField = idx"
                                    :class="activeField === idx ? 'btn-primary' : 'btn-secondary'"
                            ...
                            <div class="border border-green-300 p-6 space-y-6">
                                ...
                                <!-- Total Land Area + Unit -->
                                    <div>
                                        ...
                                        <input autofocus type="number" step="0.1" min="0"  :name="`fields[${activeField}][landArea]`"  x-model.number="fields[activeField].landArea" placeholder="e.g. 5.5" 
                                            class="form-control"/>                                
                                    </div>
                                    <div>
                                        <label class="block font-semibold text-gray-700 mb-1">Land Unit</label>
                                        <select :name="`fields[${activeField}][landUnit]`" x-model="fields[activeField].landUnit" class="form-control">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-3">
                                            ...
                                            >
                                                ...
                                                :class="fields[activeField].landType === 'nahri' ? 'text-blue-100' : 'text-gray-400'">
                                            ...
                                            >
                                                Birani (Rain-fed)
                                                <p class="text-xs mt-1"
                                                :class="fields[activeField].landType === 'birani' ? 'text-blue-100' : 'text-gray-400'">
                                ...
                                <button type="button" @click="goBack()" class="btn-secondary transition">&#8592; Back</button>
                                <button type="button" @click="validateStep(2)" class="btn-primary transition">Next Step &#8594;</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div x-show="step === 3" x-transition class="space-y-8">
                            ...
                            <div class="border border-green-300 p-6 space-y-6">
                                ...
                                <button type="button" @click="goBackToStep2()" 
                                        class="btn-secondary transition">&#8592; Previous</button>
                                <button type="submit" 
