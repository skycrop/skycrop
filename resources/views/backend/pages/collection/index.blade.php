        ...
        <div class="rounded-md border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex flex-col md:flex-row justify-between items-center gap-3">
               ...
               <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.collection.create') }}" class="btn-primary flex items-center gap-2">
            ...
            <div class="space-y-3 border-t border-gray-100 dark:border-gray-800 overflow-x-auto overflow-y-visible">
                <table id="dataTable" class="w-full dark:text-gray-300">
                    ...
                    <tbody>
                        @forelse ($collection as $cat)
                            <tr class="{{ $loop->index + 1 != count($collection) ?  'border-b border-gray-100 dark:border-gray-800' : '' }}">
                                    ...
                                    <x-buttons.action-buttons :label="__('Actions')" :show-label="false" align="right">
                                        @if (auth()->user()->can('category.edit'))
                                            <x-buttons.action-item
                                                :href="route('admin.collection.edit', $cat->id)"
                                                icon="pencil"
                                                :label="__('Edit')"
                                            />
                                        @endif
                                        {!! ld_apply_filters('collection_actions_after_edit', '', $cat) !!}                                        
                                        ...
                                        @if (auth()->user()->can('category.delete'))
                                            <div x-data="{ deleteModalOpen: false }">
                                                ...
                                                <x-modals.confirm-delete
                                                    ...
                                                    formAction="{{ route('admin.collection.destroy', $cat->id) }}"
                                        ...
                                        @endif
                                        {!! ld_apply_filters('collection_actions_after_delete', '', $cat) !!}
                        ...
                        @empty
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <td colspan="5" class="px-5 py-4 sm:px-6 text-center">
                                    <span class="text-gray-500 dark:text-gray-300">{{ __('No collection found') }}</span>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
