        ...
        <div class="space-y-6">
            <div class="rounded-md border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
                <div class="p-5 space-y-6 border-t border-gray-100 dark:border-gray-800 sm:p-6">
                    <form action="{{ route('admin.crop.update', $crop->id) }}" method="POST" class="space-y-6"
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="text" name="crop_name" id="crop_name" autofocus
                                    value="{{ $crop->crop_name }}" placeholder="{{ __('Enter Crop Name') }}"
                                    class="form-control">
                            </div>                            

                            <div>
                                <x-inputs.combobox name="suitable_season[]" label="{{ __('Suitable Season') }}"
                                    placeholder="{{ __('Select Season') }}" required
                                    :options="collect($suitable_season)
                                    ->map(fn($name, $id) => ['value' => $name, 'label' => ucfirst($name)])"
                                    :searchable="false"
                                    :selected="$crop->suitable_season"
                                    :multiple="true" />
                            </div>
                            ...
                            <div>
                                <x-inputs.combobox name="suitable_soil_types[]" label="{{ __('Suitable Soil Types') }}"
                                    ...
                                    ->map(fn($name, $id) => ['value' => $name, 'label' => ucfirst($name)])"
                                    :searchable="false"
                                    :selected="$crop->suitable_soil_types"
                                    :multiple="true" />
                            </div>
                            ...
                            <div>
                                <x-inputs.combobox name="suitable_land_types[]" label="{{ __('Suitable Land Types') }}"
                                    ...
                                    ->map(fn($name, $id) => ['value' => $name, 'label' => ucfirst($name)])"
                                    :searchable="false"
                                    :selected="$crop->suitable_land_types"
                                    :multiple="true" />
                            </div>
                            ...
                            <div>
                                <x-inputs.combobox name="suitable_water_types[]" label="{{ __('Suitable Water Types') }}"
                                    ...
                                    ->map(fn($name, $id) => ['value' => $name, 'label' => ucfirst($name)])"
                                    :searchable="false"
                                    :selected="$crop->suitable_water_types"
                                    :multiple="true" />
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="number" name="soil_ph_min" id="soil_ph_min" required autofocus
                                    value="{{ $crop->soil_ph_min }}" placeholder="{{ __('e.g. 7.5') }}"                                    
                                    step="0.1" 
                                    min="0" 
                                    max="14" 
                                    class="form-control">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="number" name="soil_ph_max" id="soil_ph_max" required autofocus
                                    value="{{ $crop->soil_ph_max }}" placeholder="{{ __('e.g. 7.5') }}"                                    
                                    step="0.1" 
                                    min="0" 
                                    max="14" 
                                    class="form-control">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="number" name="water_ph_min" id="water_ph_min" required autofocus
                                    value="{{ $crop->water_ph_min }}" placeholder="{{ __('e.g. 7.5') }}"                                    
                                    step="0.1" 
                                    min="0" 
                                    max="14" 
                                    class="form-control">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="number" name="water_ph_max" id="water_ph_max" required autofocus
                                    value="{{ $crop->water_ph_max }}" placeholder="{{ __('e.g. 7.5') }}"                                    
                                    step="0.1" 
                                    min="0" 
                                    max="14" 
                                    class="form-control">
