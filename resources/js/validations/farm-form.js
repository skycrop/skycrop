...
window.farmWizard = function() {
    return {
        ...
        initValidation() {
            try {
                this.validator = new JustValidate('#farmFormValidate');
        ...
        registerDynamicFieldRules(index) {
            ...
            // safeAddField(`[name="fields[${index}][sowingDate]"]`, [
            //     {
            //         rule: 'pattern',
            //         value: /^\d{4}-\d{2}-\d{2}$/,
            //         errorMessage: 'Date of sowing must be YYYY-MM-DD',
            //         validateWhenEmpty: true
            //     }
            // ]);

            // safeAddField(`[name="fields[${index}][harvestDate]"]`, [
            //     {
            //         rule: 'pattern',
            //         value: /^\d{4}-\d{2}-\d{2}$/,
            //         errorMessage: 'Harvest date must be YYYY-MM-DD',
            //         validateWhenEmpty: true
            //     }
            // ]);
        },
        ...
        submitFarm() {       
            ...
            .then(data => {
                ...
                window.location.href = '/user/farms';
...
export function farmFormValidation() {}
