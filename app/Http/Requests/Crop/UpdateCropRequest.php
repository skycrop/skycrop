...
class UpdateCropRequest extends FormRequest
{
    ...
    {
        return $this->checkAuthorization(Auth::user(), ['crop.edit']);
    }
    ...
    public function rules(): array
    {
        ...
        return ld_apply_filters('crop.update.validation.rules', [
    ...
    public function messages(): array
    {
        return [
            ...
            'crop_name.max' => 'The crop name may not exceed 255 characters.',
